...
from core.model.pg_modules.blocks import DownBlock, DownBlockPatch, conv2d
from core.model.pg_modules.projector import F_RandomProj
...
class SingleDisc(nn.Module):
    ...
    def __init__(
        ...
        DB = partial(
            DownBlockPatch,
            separable=separable) if patch else partial(
            DownBlock,
            separable=separable)
...
class SingleDiscCond(nn.Module):
    ...
    def __init__(
        ...
        # Down Blocks
        DB = partial(DownBlockPatch, separable=separable) if patch \
...
class ProjectedDiscriminator(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.feature_network = F_RandomProj()
