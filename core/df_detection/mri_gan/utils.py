...
class ConfigParser:
    ...
    def __init__(self):
        self.config_file = 'core/df_detection/mri_gan/config.yml'
        self.config = dict()
    ...
    def get_celeb_df_v2_real_fake_mapping_json(self):
        return os.path.join(
            self.get_assets_path(),
            self.config['data_path']['celeb_df_v2']['real_fake_mapping'])

    def get_fdf_data_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['data_path']['fdf']['data_path'])

    def get_ffhq_data_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['data_path']['ffhq']['data_path'])
    ...
    def get_fdf_json_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['features']['fdf']['json_filename'])

    def get_fdf_crops_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['features']['fdf']['crops_path'])

    def get_fdf_json_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['features']['ffhq']['json_filename'])

    def get_fdf_crops_path(self):
        return os.path.join(self.get_assets_path(),
                            self.config['features']['ffhq']['crops_path'])
