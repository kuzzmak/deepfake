...
def load_acc_loss(model=None, log_dir=None, model_type=None):
    ...
    model_valid_losses_log_file = os.path.join(
        model_log_dir,
        log_params['model_loss_info_log'],
    )
    model_valid_accuracy_log_file = os.path.join(
        model_log_dir,
        log_params['model_acc_info_log'],
    )
