...
from message.message import IOOperationBody, Message, Messages
...
class FaceDetectionWorker(Worker):
    ...
    def process(self, msg: Message):
        data = msg.body.data
        data_directory = data[BODY_KEY.INPUT_DATA_DIRECTORY]
        faces_directory = data[BODY_KEY.INPUT_FACES_DIRECTORY]
    ...
    def _process(
        ...
        logger.info('Face detection process started.')
        ...
        logger.info('Face detection process finished.')
