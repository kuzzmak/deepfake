...
class Ui_make_deepfake_page(object):
    def setupUi(self, make_deepfake_page):
        ...
        self.start_face_extraction_btn = QtWidgets.QPushButton(self.tab_2)
        self.start_face_extraction_btn.setMinimumSize(QtCore.QSize(200, 0))
        self.start_face_extraction_btn.setObjectName("start_face_extraction_btn")
        self.horizontalLayout_3.addWidget(self.start_face_extraction_btn, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, make_deepfake_page):
        ...
        self.start_face_extraction_btn.setText(_translate("make_deepfake_page", "Start face extraction"))
