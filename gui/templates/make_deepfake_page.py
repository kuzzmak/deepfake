...
class Ui_make_deepfake_page(object):
    def setupUi(self, make_deepfake_page):
        ...
        self.selected_faces_directory_label.setObjectName("selected_faces_directory_label")
        self.horizontalLayout_3.addWidget(self.selected_faces_directory_label, 0, QtCore.Qt.AlignLeft)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem2)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.select_faces_directory_btn = QtWidgets.QPushButton(self.groupBox)
        self.select_faces_directory_btn.setObjectName("select_faces_directory_btn")
        self.verticalLayout_3.addWidget(self.select_faces_directory_btn, 0, QtCore.Qt.AlignLeft)
    ...
    def retranslateUi(self, make_deepfake_page):
        ...
        self.groupBox.setTitle(_translate("make_deepfake_page", "Folder which will be used for storing extracted frames"))
        self.label_2.setText(_translate("make_deepfake_page", "Selected: "))
        self.selected_faces_directory_label.setText(_translate("make_deepfake_page", "NOTHING SELECTED"))
        self.select_faces_directory_btn.setText(_translate("make_deepfake_page", "Select"))
